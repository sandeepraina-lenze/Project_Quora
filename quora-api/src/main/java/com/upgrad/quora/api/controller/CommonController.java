...
import com.upgrad.quora.service.business.UserProfileBussinessService;
...
public class CommonController {
    @Autowired
    UserProfileBussinessService userProfileBussinessService;
    ...
    public ResponseEntity<UserDetailsResponse> userProfile(@PathVariable("userId") final String userId, @RequestHeader("authorization") final String accessToken) throws AuthorizationFailedException, UserNotFoundException {
         UserEntity userEntity = userProfileBussinessService.UserProfileEntity(userId, accessToken);
